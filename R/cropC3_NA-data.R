#' Percent C3 Crop Cover for North America
#'
#' Gridded percent C3 crop cover layer for North America in the year 2000,
#'   aggregated to 10' spatial resolution. Integrates geographic distribution of
#'   global agricultural lands (Ramankutty \emph{et al.} 2008) with distribution
#'   of crop types (Monfreda \emph{et al.} 2008), following rules described in
#'   Powell \emph{et al.} 2012.
#'
#' @docType data
#' @usage data(cropC3_NA)
